...
A hub with many sub-tabs: the **Backtester**, **All Trades** ([trades-history](#)) unified across every engine, **Strategy Lab**, **My Strategies** (your Pine), **All Sources**, plus dedicated trackers for **GEX**, **TP/SL strategies**, **Gold DCA**, **Stocks DCA**, **Polymarket**, **AI Consensus**, **Confluence**, **Hyblock** and **Footprint**.
